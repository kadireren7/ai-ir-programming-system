...
export default async function DashboardOverviewPage() {
  ...
  return (
    <div className="space-y-10">
      <div className="relative overflow-hidden rounded-3xl border border-border/70 bg-gradient-to-br from-card via-card to-primary/[0.07] p-6 shadow-lg ring-1 ring-white/[0.06] sm:p-8">
