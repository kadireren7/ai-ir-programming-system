...
from torqa.semantics.torqa_semantic_policy import (
...
from torqa.semantics.ir_logic_validation import validate_ir_goal_logic
...
def build_ir_semantic_report(
    ...
    from torqa.analysis.engine import advanced_analysis_report
